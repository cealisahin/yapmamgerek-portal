...
import { getContext } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/unhead/dist/index.mjs';
...
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/ufo/dist/index.mjs';
import { defu } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/alisahin/Documents/Development/yapmamgerek-portal/node_modules/vue/server-renderer/index.mjs';
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/detail-79f40e53.mjs').then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-62fac92a.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0211f493.mjs').then((m) => m.default || m)
  }
];
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, createError as c, asyncDataDefaults as d, entry$1 as default, useNuxtApp as e, fetchDefaults as f, useRoute as g, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
